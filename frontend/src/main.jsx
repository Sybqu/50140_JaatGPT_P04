...
function App() {
  ...
  async function findMitigation() { const data = await request('/api/mitigate', { node_id: selected, trials: 600, actions: [{ node_id: selected, action: 'PATCH' }] }); if (data) setMitigation(data) }
